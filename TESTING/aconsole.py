...
console = AbstractConsole(screen)

words = ["This", "is", "a", "test", "of", "streaming", "words.", "Each", "word", "is", "processed", "individually."]
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            # console.add_text(words[random.randint(0, len(words)-1)] + ' ')
